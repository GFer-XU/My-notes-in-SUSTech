...
```mermaid
graph LR
    A[Atmospheric Particles] --> B[Physical Behavior & Classification]
    A --> C[Chemical Processes & Formation]
    A --> D[Organic Particles]
    A --> E[Inorganic Particles]
    A --> F[Effects & Control Mechanisms]

    B --> B1[Condensation vs. Dispersion Aerosols]
    B --> B2[Diffusion, Coagulation, Sedimentation]

    C --> C1[Gas-to-Particle Conversion]
    C --> C2[Aqueous Droplet Reactions]

    D --> D1[Pyrolysis & Pyrosynthesis]
    D --> D2[Polycyclic Aromatic Hydrocarbons PAHs]

    E --> E1[Acid Rain Salts: Sulfates/Nitrates]
    E --> E2[Toxic Metals: Hg, Pb, Be]
    E --> E3[Radioactive: Radon, Cosmic Isotopes]

    F --> F1[Health: PM2.5 Respirability]
    F --> F2[Visibility: Haze & Fog]
    F --> F3[Control: Scrubbers, Precipitators, Filters]
```
...
This section perfectly maps to the 8 topics explicitly listed in the "Take-home Message" section (Slide 32) of the source material to ensure complete exam readiness.
